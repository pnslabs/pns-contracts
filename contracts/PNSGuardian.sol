...
contract PNSGuardian is Initializable, UUPSUpgradeable, IPNSGuardian, EIP712Upgradeable {
	//============STATE VARIABLES==============
	...
	function _authorizeUpgrade(address) internal override onlyGuardianVerifier {}
